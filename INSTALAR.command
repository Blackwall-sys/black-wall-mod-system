#!/usr/bin/env bash
# INSTALAR.command — Black Wall Mod System (bwms) 0.1.1 — double-click in Finder.
...
# --- language pick ---------------------------------------------------------
printf '\n  Black Wall Mod System (bwms) 0.1.1\n\n'
...
case "$LC" in
  pt)
    M_TITLE="Black Wall Mod System (bwms) 0.1.1 — alfa"
    ...
    ;;
  zh)
    M_TITLE="Black Wall Mod System (bwms) 0.1.1 — 测试版"
    ...
    ;;
  *)
    M_TITLE="Black Wall Mod System (bwms) 0.1.1 — alpha"
